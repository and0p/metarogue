...
public class CubeSide {
    ...
    float textureFloat = 0.083333333333f;
	float halfsize;
    ...
    public CubeSide(Vector3f pos, float size, int direction, int type) {
        ...
        // directions still x+-y+-y+-
        if(direction == 0) { //x+
            textureCoord[0].set(basex+0, .25f);
            textureCoord[1].set(basex+.25f, .25f);
            textureCoord[2].set(basex+.25f, .5f);
            textureCoord[3].set(basex+0, .5f);
            normal.set(1,0,0);
            corners[0].set(pos.x + halfsize, pos.y + halfsize, pos.z + halfsize);
            corners[1].set(pos.x + halfsize, pos.y + halfsize, pos.z - halfsize);
            corners[2].set(pos.x + halfsize, pos.y - halfsize, pos.z - halfsize);
        ...
        if(direction == 2) { //y+
            textureCoord[0].set(basex+0, 0f);
            textureCoord[1].set(basex+.25f, 0);
            textureCoord[2].set(basex+.25f, .25f);
            textureCoord[3].set(basex+0, .25f);
            normal.set(0,1,0);
            corners[0].set(pos.x - halfsize, pos.y + halfsize, pos.z - halfsize);
            corners[1].set(pos.x + halfsize, pos.y + halfsize, pos.z - halfsize);
            corners[2].set(pos.x + halfsize, pos.y + halfsize, pos.z + halfsize);
        ...
        if(direction == 3) {  //y-
            textureCoord[0].set(basex+0, .5f);
            textureCoord[1].set(basex+.25f, .5f);
            textureCoord[2].set(basex+.25f, .75f);
            textureCoord[3].set(basex+0, .75f);
            normal.set(0,-1,0);
            corners[0].set(pos.x - halfsize, pos.y - halfsize, pos.z + halfsize);
            corners[1].set(pos.x + halfsize, pos.y - halfsize, pos.z + halfsize);
            corners[2].set(pos.x + halfsize, pos.y - halfsize, pos.z - halfsize);
