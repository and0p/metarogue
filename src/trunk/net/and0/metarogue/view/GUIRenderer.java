...
//	public boolean bordered;
	...
	public static void renderElement(Element e) {
		...
		Vector2d[] corners = {  new Vector2d(e.position),
								new Vector2d(e.position.getX() + e.width, e.position.getZ()),
								new Vector2d(e.position.getX() + e.width, e.position.getZ() - e.height),
								new Vector2d(e.position.getX(), e.position.getZ() - e.height)
								};
